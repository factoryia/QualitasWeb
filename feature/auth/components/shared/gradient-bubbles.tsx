    ...
    >
      ...
      <div
        ...
        style={{
          ...
          animation: "auth-float-slow 12s ease-in-out infinite",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          animation: "auth-float 9s ease-in-out infinite 1s",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          animation: "auth-float-reverse 11s ease-in-out infinite 0.5s",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          animation: "auth-float-slow 14s ease-in-out infinite 2s",
        }}
      />
    </div>
  )
